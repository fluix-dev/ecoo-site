# Generated by Django 2.2.19 on 2021-04-04 00:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format_name', models.CharField(choices=[('atcoder', 'AtCoder'), ('bonuses', 'Bonuses'), ('default', 'Default'), ('ecoo', 'ECOO'), ('icpc', 'ICPC'), ('ics3u', 'ICS3U'), ('ioi', 'IOI (pre-2016)'), ('ioi16', 'IOI')], default='default', help_text='The contest format module to use.', max_length=32, verbose_name='contest format')),
                ...
                ('is_locked', models.BooleanField(default=False, help_text='Whether submission updates should be frozen. If frozen, rejudging/rescoring will not propagate to related contest submissions until after this is unchecked.', verbose_name='freeze submissions')),
            ...
            options={
                ...
                'permissions': (('join_all_contest', 'Join all contests'), ('edit_own_contest', 'Edit own contests'), ('edit_all_contest', 'Edit all contests'), ('clone_contest', 'Clone contest'), ('moss_contest', 'MOSS contest'), ('contest_rating', 'Rate contests'), ('change_contest_visibility', 'Change contest visibility'), ('contest_problem_label', 'Edit contest problem label script'), ('lock_contest', 'Change lock status of contest')),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('see_private_problem', 'See hidden problems'), ('edit_own_problem', 'Edit own problems'), ('edit_all_problem', 'Edit all problems'), ('edit_public_problem', 'Edit all public problems'), ('problem_full_markup', 'Edit problems with full markup'), ('clone_problem', 'Clone problem'), ('change_public_visibility', 'Change is_public field'), ('change_manually_managed', 'Change is_manually_managed field')),
            },
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('display_rank', models.CharField(choices=[('user', 'Normal User'), ('admin', 'Admin')], default='user', max_length=10, verbose_name='display rank')),
            ...
            options={
                ...
                'permissions': (('view_name', "View user's real name"),),
            },
        ),
        migrations.CreateModel(
            name='Submission',
            fields=[
                ...
                ('is_locked', models.BooleanField(default=False, verbose_name='lock submission')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_disqualified', models.BooleanField(default=False, help_text='Whether this submission is disqualified.', verbose_name='is disqualified')),
            ...
            options={
                ...
                'permissions': (('disqualify_submissions', 'Disqualify submissions'),),
            },
        ),
        migrations.AddField(
